...
13. **A novel idea emerges good project written by AI which can not be losslessly compressed into idea with same length again by any AI without that good idea.**
14. **Do not introduce novel idea in a script, start a new project; Do not let your project do something trivial, write a script.**
